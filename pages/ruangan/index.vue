...
import datatable from '@/datatable/ruangan/index.json'
...
export default {
  ...
  head() {
    return {
      title: 'Ruangan: Daftar Ruangan'
    }
  },

  async fetch({ store }) {
    await Promise.all([store.commit('setUrl', 'ruangan')])
