      ...
      <v-card-text>
        <v-row>
          <v-col cols="3" class="no-p">
            ...
            <small class="error--text d-flex justify-center">{{
                    ...
                    <v-row>
                      <v-col cols="10" class="no-p">
                        ...
                        <!-- <v-select
                          label="Pilih Foto *"
                          v-model="form.warna[index].image_id"
                          :error="errors.image_id ? true : false"
                          :error-messages="
                            errors.image_id ? errors.image_id[0] : ''
                          "
                          @input="form.first = false"
                          outlined
                          dense
                        ></v-select> -->
                      </v-col>
        ...
        <v-btn class="my-3" color="primary" small @click="pushTable()"
          ><v-icon small left>mdi-plus</v-icon>Tambah Baris</v-btn
        >
                ...
                <v-col cols="12" class="no-p">
                  <template v-for="(item, index) in form.detail.length">
                    <v-row :key="index">
                      ...
                      <v-col cols="1" class="d-flex align-center no-p">
                        ...
                        <!-- <v-tooltip right>
                          <template v-slot:activator="{ on }">
                            <v-btn
                              ...
                              class="mt-3"
                              v-on="on"
                              @click="destroyDetail(index)"
                            >
                              <v-icon>mdi-minus</v-icon>
                            </v-btn>
                          </template>
                          <span>Kurangi Kelengkapan</span>
                        </v-tooltip> -->
                      </v-col>
                    </v-row>
                    <v-divider
      ...
      <v-card>
        <v-card-text>
          <v-row>
            ...
            <v-col cols="2" class="d-flex align-center no-p">
