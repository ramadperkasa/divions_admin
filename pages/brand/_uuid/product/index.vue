    ...
    <v-flex xs12 sm12 md12>
      <v-card>
        ...
        <v-toolbar dense flat>
          ...
          <create
            @click.native="
              $router.push('/brand/' + $store.state.app.app + '/product/form')
            "
          ></create>
          <exit
        ...
        <v-card-text>
          ...
          >
            ...
            <template v-slot:item.nama="{ item }">{{ item.judul }}</template>
            ...
            <template v-slot:item.produk_kategori_id="{ item }">{{
              item.brand_kategori_produk ? item.brand_kategori_produk.nama : ''
            }}</template>
