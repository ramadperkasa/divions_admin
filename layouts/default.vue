    ...
    >
      ...
      <v-list dense nav>
        <div v-for="item in items" :key="item.title">
            ...
            >
              ...
              <template v-for="subItem in item.items">
                <v-list-item
                  ...
                  :key="subItem.title"
                  :to="subItem.target ? false : subItem.to"
                  @click="subItem.target ? blank(subItem.to) : false"
                  router
                >
          ...
          <div v-else>
            <v-list-item v-if="manage(item.name)" :to="item.to" router exact>
              <v-list-item-action>
    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          title: 'News',
          to: '/',
          name: ['read-berita', 'read-berita-kategori'],
          items: [
            {
        ...
        },
        {
          ...
          items: [
            ...
            {
              icon: 'mdi-file-cog',
              title: 'Setting Booking',
              to: '/setting-booking',
              name: 'read-setting-booking'
            },
            {
        ...
        },
        {
          ...
          title: 'Inventaris',
          to: '/',
          name: ['read-inventaris', 'read-inventaris-jenis'],
          items: [
            {
              icon: 'mdi-wardrobe-outline',
              title: 'Jenis Inventaris',
              to: '/inventaris/jenis',
              name: 'read-inventaris-jenis'
            },
        ...
        //   icon: 'mdi-bell-ring',
        //   title: 'Broadcast',
        //   to: '/subscribe/broadcast',
        //   name: 'read-subscribe-broadcast',
        //   items: []
        // },
        // {
        //   icon: 'mdi-account-details-outline',
        ...
        // },
        {
          ...
          title: 'Vacancy',
          to: '/',
          name: ['read-vacancy', 'read-vacancy-kategori', 'read-vacancy-sub'],
          items: [
            {
            ...
            {
              icon: 'mdi-account-details-outline',
              title: 'Sub Kategori Vacancy',
              to: '/vacancy/sub',
              name: 'read-vacancy-kategori'
            },

            {
              icon: 'mdi-account-details',
              title: 'Kategori Vacancy',
              to: '/vacancy/kategori',
              name: 'read-vacancy-sub'
            }
          ]
        },
        {
          ...
          title: 'Uploads',
          to: '',
          name: ['read-uploads', 'read-uploads-folder'],
          items: [
            {
        ...
        },
        {
          ...
          to: '',
          name: ['read-daftar-brand', 'read-daftar-brand-kategori'],
          items: [
            {
              icon: 'mdi-office-building',
              title: 'List Product',
              to: '/daftar-brand',
              name: 'read-daftar-brand',
              items: []
            },
            {
              icon: 'mdi-home-group',
              title: 'Category Product',
              to: '/daftar-brand/kategori',
              name: 'read-daftar-brand-kategori'
            }
          ]
        },
        {
          ...
          title: 'Bank',
          to: '',
          name: ['read-bank', 'read-bank-rekening'],
          items: [
            {
              icon: 'mdi-bank',
              title: 'List Bank',
        ...
        },
        {
          ...
          title: 'Infaq',
          to: '',
          name: ['read-infaq', 'read-infaq-type'],
          items: [
            {
              icon: 'mdi-menu-swap-outline',
              title: 'Type Infaq',
              to: '/infaq/type',
              name: 'read-infaq-type',
              items: []
            },
            {
              icon: 'mdi-current-ac',
        ...
        },
        {
          ...
          to: '/setting-beranda',
          name: ['read-slider', 'read-setting-beranda'],
          items: [
            {
              icon: 'mdi-card-text',
              title: 'Running Text',
            ...
            },
            {
              ...
              to: '/setting-beranda',
              name: 'read-setting-beranda'
            },
            {
              icon: 'mdi-cog-transfer-outline',
              title: 'Setting Layout',
              to: '/setting-layout',
              name: 'read-setting-layout'
            }
          ]
        },
        {
