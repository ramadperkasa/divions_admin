...
<script>
import action from '~/components/berita/action'
import page1 from '~/components/berita/page1'
import page2 from '~/components/berita/page2'
import pageEn from '~/components/berita/pageEn'
...
export default {
  ...
  computed: {
    ...
    page: {
      ...
      set(page) {
        this.$store.commit('berita/setStep', page)
      }
    }
  },
  components: {
